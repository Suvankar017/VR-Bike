...
namespace ReVR.Vehicles.Bike
{
    ...
    public class BikeAlignerAndRotatorFeature : BikeFeature
    {
        ...
        [SerializeField] private SharedFloat m_AlignRotatorSpeedInGround = 20.0f;
        ...
        public override void OnAwake(BikeBlackboard blackboard)
        {
            ...
            m_Blackboard.alignRotatorSpeedInGround = m_AlignRotatorSpeedInGround;
        }
        ...
        private void AlignRotator(Transform rotator, Vector3 projectedForward, Vector3 projectedUp)
        {
            ...
            float rotationSpeed = m_Blackboard.isGrounded ? m_AlignRotatorSpeedInGround.value : m_AlignRotatorSpeedInAir;
